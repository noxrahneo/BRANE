...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--threshold-dir",
        default="results/15_permutation_thresholds",
        help="Permutation threshold output directory from script 30",
    )
    parser.add_argument(
        "--output-dir",
        default="results/16_permutation_networks",
        help="Output directory for stage-09 branch B",
    )
    parser.add_argument(
        "--pair",
        action="append",
